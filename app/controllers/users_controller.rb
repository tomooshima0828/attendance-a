...
class UsersController < ApplicationController
  before_action :set_user,
                only: %i[show attendance_confirmation edit update destroy edit_basic_info update_basic_info]
  ...
  before_action :admin_user,
                only: %i[index destroy edit_basic_info update_basic_info working_employees edit_basic_info2]
  before_action :non_admin_user, only: :show
  before_action :set_one_month, only: %i[show attendance_confirmation]
